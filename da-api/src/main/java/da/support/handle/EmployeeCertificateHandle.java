...
public class EmployeeCertificateHandle {
    ...
    public boolean hasThreeCertificateSameType(String employeeId, String certificateId, LocalDate now) {
        return employeeCertificateRepository.hasThreeCertificateSameType(employeeId, certificateId, now) >= Constants.MAX_SAME_TYPE_CERTIFICATE;
    }

    public EmployeeCertificate toEntity(UUID id, EmployeeCertificateDto dto, boolean update) {
        EmployeeCertificate employeeCertificate = update ? employeeCertificateRepository.getById(id) : new EmployeeCertificate();
    ...
    public StatusMessage employeeCertificateValidate(EmployeeCertificateDto dto) {
        ...
        return considerTheConditionsToAdd(dto);
    ...
    public StatusMessage considerTheConditionsToAdd(EmployeeCertificateDto dto) {
        ...
        if (hasThreeCertificateSameType(employeeId, certificateId, now)) {
